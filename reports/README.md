...
Den här mappen innehåller *granskningsbara* resultat: vad som kördes, vad som observerades, och vad som faktiskt är nytt.

## Index

- `exp_001_sae.md` — SAE på GPT-2 lager 5 + Field View risk-signal (v1–v3)
...
- Setup: modell, lager, prompts/dataset, parametrar
- Resultat: metriker (med filstigar till JSON/artefakter)
- Observationer: *vad som faktiskt händer* (inte tolkning först)
- Tolkning: hypotes, mekanism, prediktion
